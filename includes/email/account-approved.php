<div style="max-width: 560px;padding: 20px;background: #ffffff;border-radius: 5px;margin: 40px auto;font-family: Open Sans,Helvetica,Arial;font-size: 15px;color: #666">
    ...
    <div style="padding: 30px;border-bottom: 3px solid #eeeeee">
        <div style="font-size: 24px;text-align: center;line-height: 40px">
            Your account has been approved!
        </div>
        <div style="padding: 30px 0;text-align: center">
            <a style="background: #555555;color: #fff;padding: 12px 30px;text-decoration: none;border-radius: 3px;" href="<?php echo get_bloginfo('url') ?>/login">Login</a>
        </div>
        <div style="text-align: center;">
            If you have any problems, please <a style="color: #3ba1da;text-decoration: none" href="mailto:dev@heretic.agency">contact us.</a>
        </div>
    </div>
